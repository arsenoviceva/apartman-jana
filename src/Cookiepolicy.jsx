    ...
    <div className="p-1">
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to Apartman Jana Bijeljina.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Apartman Jana Bijeljina, accessible
          from{" "}
          <a
      ...
      <ul>
        <li>
          <p>By email: apartmanjanabn@gmail.com</p>
        </li>
        <li>
          <p>By mail: Atinska 25, Bijeljina, Republika Srpska</p>
        </li>
      </ul>
    </div>
  );
